...
namespace HotelLiveDAL.Migrations
{
    ...
    [Migration("20231216025845_AlterBookingPayment")]
    partial class AlterBookingPayment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelLiveDAL.Model.TblBooking", b =>
                {
                    ...
                    b.Property<decimal>("CashCollect")
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.Property<decimal>("ProductComission")
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("HotelLiveDAL.Model.TblBookingPackage", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIGINT(20)");
                    ...
                    b.HasIndex("MassauerID");

                    b.ToTable("booking_package");
                });

            modelBuilder.Entity("HotelLiveDAL.Model.TblBookingPayment", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIGINT(20)");
            ...
            modelBuilder.Entity("HotelLiveDAL.Model.TblBookingProduct", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIGINT(20)");
            ...
            modelBuilder.Entity("HotelLiveDAL.Model.TblMassauerAttendance", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIGINT(20)");
                    ...
                    b.ToTable("massauer_attendance");
                });

            modelBuilder.Entity("HotelLiveDAL.Model.TblMassauerComission", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIGINT(20)");
            ...
            modelBuilder.Entity("HotelLiveDAL.Model.TblMemberCreditMovement", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIGINT(20)");
                    ...
                    b.ToTable("member_credit_movement");
                });
            ...
            modelBuilder.Entity("HotelLiveDAL.Model.TblNote", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIGINT(20)");
            ...
            modelBuilder.Entity("HotelLiveDAL.Model.TblPaymentMethod", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIGINT(20)");
            ...
            modelBuilder.Entity("HotelLiveDAL.Model.TblProduct", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIGINT(20)");
            ...
            modelBuilder.Entity("HotelLiveDAL.Model.TblShop", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIGINT(20)");
                    ...
                    b.Property<bool>("IsParadigm")
                        .HasColumnType("tinyint(1)");

                    b.Property<short>("ItemDisplay")
                        .HasColumnType("smallint(6)");
                    ...
                    b.Property<string>("ParadigmCode")
                        .HasColumnType("varchar(20)");
            ...
            modelBuilder.Entity("HotelLiveDAL.Model.TblTopup", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIGINT(20)");
                    ...
                    b.Property<long>("TopupPlanID")
                        .HasColumnType("BIGINT(20)");

                    b.Property<string>("TopupPlanName")
                        .HasColumnType("varchar(100)");
                    ...
                    b.HasIndex("TopupPlanID");

                    b.ToTable("topup");
                });

            modelBuilder.Entity("HotelLiveDAL.Model.TblTopupPlan", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIGINT(20)");
            ...
            modelBuilder.Entity("HotelLiveDAL.Model.TblBookingPackage", b =>
                {
                    b.HasOne("HotelLiveDAL.Model.TblBooking", "TblBookings")
                        .WithMany()
            ...
            modelBuilder.Entity("HotelLiveDAL.Model.TblBookingProduct", b =>
                {
                    b.HasOne("HotelLiveDAL.Model.TblBooking", "TblBookings")
                        .WithMany("TblBookingProducts")
                        .HasForeignKey("BookingID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HotelLiveDAL.Model.TblProduct", "TblProducts")
                        .WithMany()
            ...
            modelBuilder.Entity("HotelLiveDAL.Model.TblMassauerComission", b =>
                {
                    b.HasOne("HotelLiveDAL.Model.TblMassauer", "TblMassauers")
                        .WithMany("TblMassauerComissions")
                        .HasForeignKey("MassauerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("HotelLiveDAL.Model.TblTopup", b =>
                {
                    ...
                    b.HasOne("HotelLiveDAL.Model.TblTopupPlan", "TblTopupPlans")
                        .WithMany()
                        .HasForeignKey("TopupPlanID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
